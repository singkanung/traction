...
$posisi   = "";
    ...
    if(isset($_POST['tambah'])){
        $pr = mysqli_real_escape_string($connect, $_POST['pr']);
        $po = mysqli_real_escape_string($connect, $_POST['po']);
        ...
        $eta = mysqli_real_escape_string($connect, $_POST['eta']);
        $posisi = mysqli_real_escape_string($connect, $_POST['posisi']);

        if ($pr && $po && $item && $cost && $qty && $tanggal && $eta && $posisi) {
                $sql1 = "INSERT INTO tracking(pr,po,item,cost,qty,tanggal,eta,posisi) VALUES ('$pr', '$po', '$item', '$cost', '$qty', '$tanggal', '$eta', '$posisi')";
                ...
                if ($q1) {
                    ...
                    <script>
                      ...
                      document.location.href = 'formtracking.php';
                    </script>";
                }
            }
        }
...
<head>
    ...
    <title>ICT Petrosea KJA | Form Tracking</title>
    ...
    <!-- touchspin CSS
	============================================ -->
    <link rel="stylesheet" href="touchspin/jquery.bootstrap-touchspin.min.css">
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Create Tracking</h4><br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pr" id="pr" class="form-control" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row"><br>
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="cost" id="cost" placeholder=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="example-datetime-local-input" class="col-sm-3 col-form-label">ETA</label>
                                        <div class="col-sm-9">
                                            <input type="datetime-local" name="eta" id="eta" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    <!-- touchspin JS
	============================================ -->
    <script src="touchspin/jquery.bootstrap-touchspin.min.js"></script>
    <script src="touchspin/touchspin-active.js"></script>
