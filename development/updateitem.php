...
if (!isset($_SESSION['user_name'])) {
    ...
    $sql=mysqli_query($connect, "SELECT * FROM item, kategori WHERE item.kategori_id=kategori.id_kategori AND id_item='$_GET[id]'");
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Form Update Item</h4><br>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_item" id="nama_item" class="form-control" value="<?php echo $data['nama_item'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="deskripsi_item" id="deskripsi_item" class="form-control" value="<?php echo $data['deskripsi_item'] ?>">
                                        </div>
                                    </div>
                                </div>
                            </div><br>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        &nbsp;<button class="btn btn-success mb-xl-3" type="submit" value="simpan" name="edit"><span class="ti-save">&nbsp;</span>Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php
                    if(isset($_POST['edit'])){
                    mysqli_query($connect, "UPDATE item SET
                        nama_item = '$_POST[nama_item]',
                        deskripsi_item = '$_POST[deskripsi_item]',
                        kategori_id = '$_POST[id_kategori]' WHERE id_item=$_GET[id]") or die(mysqli_error($connect));

                    echo "
                        <script>
                            alert('Successfully to update your item');
