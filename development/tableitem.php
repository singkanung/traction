                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="tableitem.php">Master</a></li>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Table Item</h4><br>
                                &nbsp;<a class="btn btn-success mb-xl-3" href="formitem.php" role="button"><span class="fa fa-plus-square">&ensp;</span>CREATE&nbsp;</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                    <div id="toolbar">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true"  data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>&emsp;&emsp;
                                                ...
                                                <th data-field="email">Descriptions</th>
                                                <th data-field="phone">Kategori</th>
                                        ...
                                        <?php
                                            require 'config.php';
                                            $i = 1;
                                            $query = "SELECT * FROM item INNER JOIN kategori ON item.kategori_id = kategori.id_kategori";
                                            $sql = mysqli_query($connect, $query) or die (mysqli_error($connect));
                                            while ($data = mysqli_fetch_array($sql)) { ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $data["nama_item"]; ?></td>
                                                <td><?php echo $data["deskripsi_item"]; ?></td>
                                                <td><?php echo $data["nama_kategori"]; ?></td>
                                                <td><a href="updateitem.php?id=<?php echo $data['id_item'];?>" class="text-secondary"><i class="fa fa-edit"></i></a>&emsp;
                                                    <a href="deleteitem.php?id=<?php echo $data['id_item'];?>" onclick="return confirm('Delete data item?');" class="text-danger"><i class="ti-trash"></i></a></td>     
                                                </td>
                                            </tr>
                                        <?php
                                        }
