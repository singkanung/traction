...
if(isset($_POST['tambah'])){
    ...
    $sql = "INSERT INTO kategori VALUES ('', '$nama_kategori')";
        ...
        echo "
            <script>
              alert('Failed to add your category');
              document.location.href = 'formcategory.php';
            </script>";
            }   
        }
...
<head>
    ...
    <title>Tracking ICT | Master Category</title>
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Form Create Category</h4><br>
